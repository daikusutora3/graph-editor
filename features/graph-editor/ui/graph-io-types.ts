...
export type PngExportLongEdgePreset =
  | 640
  | 1024
  | 1600
  | 2048
  | 3840
  | "custom";
export type PngExportPaddingPreset = 0 | 48 | 96 | "custom";
export const PNG_EXPORT_LONG_EDGE_PRESETS = [
  640, 1024, 1600, 2048, 3840,
] as const;
export const PNG_EXPORT_PADDING_PRESETS = [0, 48, 96] as const;
