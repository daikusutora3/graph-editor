...
const fieldBase =
  "ge-focus h-8 w-full min-w-0 rounded-lg border border-[var(--line)] bg-[var(--fill)] px-2.5 text-[12.5px] font-semibold text-[var(--text)] outline-none placeholder:text-[var(--faint)]";
