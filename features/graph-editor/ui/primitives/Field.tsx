...
const fieldBase =
  "ge-focus h-8 w-full min-w-0 rounded-lg touch:h-11 touch:text-sm border border-[var(--line)] bg-[var(--fill)] px-2.5 text-control font-semibold text-[var(--text)] outline-none placeholder:text-[var(--muted)]";
