...
export function GraphStarterCard({
  ...
  return (
    ...
    >
      {!open ? (
        <div className="gv-empty-start flex w-[min(24rem,calc(100vw-3rem))] -translate-y-[3vh] flex-col items-center gap-[var(--app-space-6)] text-center">
          <div className="flex min-w-0 flex-col items-center gap-[var(--app-space-4)]">
            <span className="relative grid size-28 shrink-0 place-items-center">
              <img
                ...
                width={112}
                height={112}
                className="brand-logo-image-light size-28 object-contain select-none"
                draggable={false}
              />
              <img
                ...
                width={112}
                height={112}
                className="brand-logo-image-dark size-28 object-contain select-none"
                draggable={false}
              />
            </span>
            <span className="flex min-w-0 flex-col items-center gap-1.5">
              <span
                translate="no"
                className="max-w-full truncate [font-family:var(--app-font-display)] text-[1.625rem] leading-[var(--app-leading-tight)] font-bold text-[var(--text)]"
              >
                {messages.app.title}
              </span>
              <span className="max-w-full truncate text-[length:var(--app-text-xs)] leading-[var(--app-leading-tight)] font-medium text-[var(--text-mute)]">
                {messages.app.byline}
              </span>
            </span>
          </div>
